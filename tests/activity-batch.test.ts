...
test("批量活动只允许未过期、命中用户关键词且有详情的材料进入模型",()=>{
 ...
 const data=activityBatchSchema.parse({schemaVersion:"draftdesk.activity-batch.v1",keywords:["Vibe Coding"],platform:"小红书",warnings:[],items:[{platform:"小红书",title:"Vibe Coding 小工具创作活动",url:"https://creator.xiaohongshu.com/new/events",text:"官方活动详情：面向创作者征集 AI 小工具开发过程，要求展示作品与方法，并使用指定活动话题提交笔记。",dateText:"09-01 至 09-30",endsAt:"2026-09-30T15:59:59Z",completeness:"detail",capturedAt:"2026-09-24T03:00:00Z"}]});
